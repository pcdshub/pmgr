...
('FLD_EL','EL', 'Encoder Lines', '',12,0,1),
...
('FLD_RC','RC', 'run current (%: 0..100)', '',16,0,0),
...
('FLD_UREV','UREV', 'Units per Revolution (EGU/Rev)', '',21,0,3),
('FLD_FREV','FREV', 'Full Steps per Rev', '',22,0,0),
('FLD_SREV','SREV', 'micro-steps per revolution', '',23,0,0),
('FLD_ERES','ERES', 'Encoder Step Size (EGU)', '',24,0,1),
...
('FLD_SBAS','SBAS', 'base speed (Rev/s)', '',40,0,0),
('FLD_SMAX','SMAX', 'max speed [Rev/s]', '',41,0,0),
('FLD_S','S', 'speed (Rev/s)', '',42,1,0),
('FLD_BS','BS', 'Backlash Speed (EGU/s)', '',43,1,0),
('FLD_HS','HS', 'Home speed (Rev/s)', '',44,1,0),
